...
class Frontier_Explorer(Node):
    ...
    def explore(self):
        ...
        frontier_mask = np.where(
            (unoccupied >= 0.30) &      # near free space
            (unknown >= 0.20) &         # near unknown space
            (occupied == 0),          # not near obstacles
            1, 0
        )
        ...
        print(f"Publishing frontier goal: {msg.x:.2f}, {msg.y:.2f}")
